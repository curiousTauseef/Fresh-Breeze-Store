...
<br><br><br>
<div class="container">
		<form:form method="post" modelAttribute="employee" action="/storemanager/updateemployee/" class="form-horizontal" role="form">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" value="${employee.employee_id}" name="employee_id" class="form-control" id="employee_id"
                               placeholder="Employee Id" required ="true" readonly>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-user"></i></div>
                        <input type="text" value="${employee.name}" name="name" class="form-control" id="username"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="date" value="${employee.joining_date}" name="joining_date" class="form-control" id="joiningdate"
                               placeholder="Date of Joining" required="true" readonly>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" name="salary" class="form-control" id="salary"
                               placeholder="Salary" required="true">
                    </div>
                </div>
            </div>
