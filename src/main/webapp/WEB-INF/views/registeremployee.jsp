...
<br><br><br>
<div class="container">
		<form:form method="post" modelAttribute="employee" action="/storemanager/registeremployee/" class="form-horizontal" role="form">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="date" name="joining_date" class="form-control" id="joiningdate"
                               placeholder="Date of Joining" required="true">
                    </div>
                </div>
            </div>
